<template>
  <div class="fill-height d-flex ga-3 flex-column">
    <alex-learningplan-trails-contributions-side-bar
      ...
      :is-professor="learningPlanStore.userIsFacilitator || true"
    ...
    <div id="editor-container" class="bg-white rounded w-100 container-min-height">
      <div section="0" class="d-flex justify-end px-6 pt-6" :class="!readOnly ? 'sticky-buttons' : ''">
        ...
        />
        <alex-custom-button
          v-if="readOnly && (learningPlanStore.userIsFacilitator || true) && !trailStore.loading"
          variant="primary"
          size="large"
          class="ml-2"
        ...
        >
        <div v-else-if="(learningPlanStore.userIsFacilitator || true) && !isLoading">
          <alex-custom-button
            variant="secondary"
            size="large"
      ...
      <div v-else class="container-min-height justify-center ma-6 align-start d-flex">
        <div style="width: 800px">
          ...
          <div v-if="readOnly">
            ...
            <div
              v-if="!learningPlanStore.userIsFacilitator || true"
