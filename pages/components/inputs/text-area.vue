<template>
  ...
  >
    <h1 class="text-h2 text-gray-800">Text Area</h1>
    <p class="text-subtitle-2 text-gray-500">
      O
      <strong class="bg-accent pa-1 rounded">alex-inputs-text-area</strong>
      é um componente que utiliza a estrutura do Vuetify para criar um campo de
      texto maior que o convencional, normalmente usado para descrições.
    </p>
    <div class="d-flex align-center container rounded-lg pa-4">
      ...
      <div>
        ...
        <a
          ...
          href="https://vuetifyjs.com/en/components/textareas/#usage"
          target="_blank"
          >vuetifyjs.com</a
        >
      </div>
    ...
    <div>
      <p class="text-subtitle-2 text-gray-500">
        ...
        <a
          class="text-decoration-underline text-blue"
          href="https://vuetifyjs.com/en/api/v-textarea/#links"
          target="_blank"
          >v-textarea</a
    ...
    <alex-inputs-text-area
      v-model="inputText"
      placeholder="O que deseja descrever?"
      name="area"
      class="w-100"
