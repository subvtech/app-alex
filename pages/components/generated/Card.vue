<template>
  ...
  >
    <alex-documentation-header title="Card" description="undefined" />
    ...
    <alex-documentation-playground :data="myProps">
      <template #component="{ props }">
        <alex-custom-card
          ...
          :controlsLoading="props.controlsLoading"
          :sizingClass="props.sizingClass"
          :tooltipExtraClass="props.tooltipExtraClass"
...
const myProps = [
  ...
  },
  {
    ...
    required: false,
    description: `There's no description.`,
    type: `'align-center' | 'align-start' | 'align-end'`,
    initialValue: 'align-start',
    default: `align-start`,
  },
  {
    name: `href`,
