<template>
  <div class="content-block d-flex w-100 gap-6">
    <div class="details d-flex flex-column w-100 gap-6">
      ...
      <profile-socials
        ...
        :userId="userId"
        @update:user="
          emit('update:user', $t('components.profile.socials.update'))
        "
      />
    </div>
    <div class="d-flex flex-column w-100 gap-6">
      ...
      >
        <competences
          ...
          @update:user="
            emit('update:user', $t('components.competences.technical.updated'))
          "
        />
        <competences
...
const updateAbout = async (text) => {
  ...
  emit('update:user', i18n.t('pages.profile.about.updated'));
};
</script>
