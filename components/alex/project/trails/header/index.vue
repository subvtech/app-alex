<template>
  <div v-if="trailStore.loading && showSkeleton" class="d-flex flex-column gap-1 my-6 bg-white rounded">
    <div class="d-flex gap-4 w-100 px-6 pt-6">
      <alex-custom-skeleton color="gray-300" class="width-50 height-37" rounded="md" />
  ...
  <div v-else>
    <div class="bg-white rounded my-6">
      <div class="d-flex px-6 py-6 justify-start align-start align-self-stretch flex-wrap">
        <div class="header-row">
          ...
          <div class="h-text">
            <div class="header-text">
              ...
              <span class="text-body-1 text-gray-600 w-100"> {{ trailsDescription }}</span>
            </div>
          </div>
        </div>
      </div>
      <div class="d-flex flex-row justify-space-between align-center pr-2 customTabs">
...
const defaultURL = computed(() => {
  return `/projects/${props.courseId}/trails/${props.trailId}`;
});
