<template>
  <alex-custom-breadcrumbs
    ...
    :items="[
      ...
      { title: 'Configurações', disabled: true, href: '/settings' },
    ]"
  />
  <div
    style="
    ...
    <v-container fluid class="header">
      <v-row class="header-row">
        <v-col cols="2" width="200px">
          <img
            src="https://www.les3vallees.com/media/cache/hero_single/ete-activite-solo-trail-courchevel-arthur-bertrand-1920x1080-473.jpg"
