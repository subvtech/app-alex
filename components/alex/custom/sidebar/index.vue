<template>
  ...
  <DialogRoot v-if="!isPermanent" v-model:open="drawer">
    <DialogPortal>
      <DialogOverlay
        class="tw-fixed tw-inset-0 tw-z-[1200] tw-bg-black/30 data-[state=open]:tw-animate-in data-[state=closed]:tw-animate-out data-[state=closed]:tw-fade-out-0 data-[state=open]:tw-fade-in-0"
        side="left"
      />
      <DialogContent
